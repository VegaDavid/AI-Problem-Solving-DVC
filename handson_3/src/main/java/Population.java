//Coded By David de Jesus Vega Campos 
//AI Problem Solving I
...
public class Population
{
    ...
    final static int POP_SIZE = 6 + ELITISM_K;  // population size
    final static int MAX_ITER = 1000;             // max number of iterations
    final static double MUTATION_RATE = 0.05;     // probability of mutation
    final static double CROSSOVER_RATE = 0.2;     // probability of crossover
    ...
    public static void main(String[] args) 
    {
        ...
        // current population
        System.out.println("Evolutionary Agents.");
        System.out.println("_______________________________");
        System.out.println("Using Roulette Wheel Selection");
        System.out.println();
        System.out.print("Population Fitness = " + pop.totalFitness);
        ...
        for (int iter = 0; iter < MAX_ITER; iter++) 
        {
            ...
            pop.evaluate();
            System.out.print("Generacion # " + iter + "Total Fitness = " + pop.totalFitness);
            System.out.println(" - Best Fitness = " +
                pop.findBestIndividual().getFitnessValue()); 
